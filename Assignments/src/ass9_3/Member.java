...
public class Member implements IMember {
	 ...
	 * visible to the inner class return "Name :" + name + " " +
	 * "Membership Duration :" + membershipDuration() + " days" + " " +
	...
	public String toString() {
		return "Member [name=" + name + ", membershipDuration="
				+ membershipDuration() + "days" + ", membershipPrice="
	...
	public class Address { // inner class
		...
		@Override
		public String toString() {
			return "Address [Street_name=" + Street_name + ", house_number="
					+ house_number + ", postal_code=" + postal_code + ", city="
					+ city + "]";
		}

		/*
		 * public String toString() { return "Street name: " + Street_name + " "
		 * + "House Number: " + house_number + " " + "Postal code: " +
